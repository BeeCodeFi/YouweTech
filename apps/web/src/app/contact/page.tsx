...
const contactInfo = [
  { icon: Mail, label: 'Email', value: 'hello@youwetech.com' },
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <HeroEntrance delay={0.1}>
            <p className="text-muted-foreground mx-auto mt-4 max-w-2xl">
              Have a project in mind? Fill out the form below and we&apos;ll get back to you within
              24 hours.
            </p>
          </HeroEntrance>
        </div>
            ...
            <StaggerList className="space-y-4">
              {contactInfo.map(({ icon: Icon, label, value }) => (
                <StaggerItem key={label}>
                  <Card className="hover:border-primary/30 hover:shadow-primary/10 transition-all duration-200 hover:shadow-md">
